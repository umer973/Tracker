...
namespace Tracker
{
    public partial class FrmProject : Form
    {
        ...
        protected DataTable FillData()
        {
            ...
            if (dsComypan.Tables[2].Rows.Count > 0)
            {
                DataGridCustomer.DataSource = dsComypan.Tables[2];
        ...
        protected bool Update()
        {
            ...
            int pkID = ObjUserDal.UpdateProject(ObjUser);
            if (pkID > 0)
            {
        ...
        private void DataGridCustomer_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == DataGridCustomer.Columns["Edit"].Index)
                {
                    ...
                    {
                        TxtTask.Text = Convert.ToString(ds.Tables[0].Rows[0]["Task"]);
